...
export default function Header({ loggedIn, name, imageUrl }: { loggedIn: boolean, name: string, imageUrl: string }) {
      ...
      return (
            <header className="w-full flex items-center justify-between p-4 bg-white dark:bg-zinc-900">
                  <div className="flex items-center space-x-4">
                        ...
                        <h1 className="text-xl font-bold text-zinc-800 dark:text-zinc-50">{name}</h1>
                  </div>
